...
namespace fc
{
    void to_variant( const ohl::blockchain::public_key_type& var,  fc::variant& vo )
    {
        vo = std::string(var);
    }

    void from_variant( const fc::variant& var,  ohl::blockchain::public_key_type& vo )
    {
        vo = ohl::blockchain::public_key_type( var.as_string() );
    }
} // fc
