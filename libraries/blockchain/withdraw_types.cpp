...
namespace ohl { namespace blockchain {
                                                              ...
                                                              bool use_stealth_address)
   {
      ...
      if( memo_message.size() <= OHL_BLOCKCHAIN_MAX_MEMO_SIZE )
      {
...
namespace fc {
   ...
   { try {
      ...
      if( obj.contains( "from" ) )
         vo.from = obj["from"].as<ohl::blockchain::public_key_type>();
      ...
      if( obj.contains( "memo_flags") )
         vo.memo_flags = obj["memo_flags"].as<ohl::blockchain::memo_flags_enum>();
