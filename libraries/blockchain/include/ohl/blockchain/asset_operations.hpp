...
FC_REFLECT( ohl::blockchain::create_asset_operation,
        (symbol)
        (name)
        (description)
        (public_data)
...
FC_REFLECT( ohl::blockchain::issue_asset_operation,
        (amount)
        )
FC_REFLECT( ohl::blockchain::asset_update_properties_operation,
        (asset_id)
        (issuer_id)
        (name)
        (description)
...
FC_REFLECT( ohl::blockchain::asset_update_permissions_operation,
        (asset_id)
        (authority)
        (authority_flag_permissions)
        (active_flags)
        )
FC_REFLECT( ohl::blockchain::asset_update_whitelist_operation,
        (asset_id)
        (account_ids)
        )
