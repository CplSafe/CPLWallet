...
FC_REFLECT( ohl::blockchain::withdraw_operation, (balance_id)(amount)(claim_input_data) )
FC_REFLECT( ohl::blockchain::deposit_operation, (amount)(condition) )
FC_REFLECT( ohl::blockchain::burn_operation, (amount)(account_id)(message)(message_signature) )
FC_REFLECT( ohl::blockchain::release_escrow_operation, (escrow_id)(released_by)(amount_to_receiver)(amount_to_sender) )
FC_REFLECT( ohl::blockchain::update_balance_vote_operation, (balance_id)(new_restricted_owner)(new_slate) )
FC_REFLECT( ohl::blockchain::limit_fee_operation, (max_fee) )
