...
FC_REFLECT( ohl::blockchain::snapshot_record, (original_address)(original_balance) )
FC_REFLECT( ohl::blockchain::balance_record, (condition)(balance)(restricted_owner)(snapshot_info)(deposit_date)(last_update)(meta_data) )
