...
FC_REFLECT( ohl::blockchain::transaction, (expiration)(reserved)(operations) )
FC_REFLECT_DERIVED( ohl::blockchain::signed_transaction, (ohl::blockchain::transaction), (signatures) )
FC_REFLECT( ohl::blockchain::transaction_location, (block_num)(trx_num) )
