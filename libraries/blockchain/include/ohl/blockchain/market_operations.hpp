...
#include <ohl/blockchain/market_records.hpp>
...
FC_REFLECT_DERIVED( ohl::blockchain::market_index_key_ext, (ohl::blockchain::market_index_key), (limit_price) )
FC_REFLECT( ohl::blockchain::bid_operation, (amount)(bid_index) )
FC_REFLECT( ohl::blockchain::ask_operation, (amount)(ask_index) )
FC_REFLECT( ohl::blockchain::short_operation, (amount)(short_index) )
FC_REFLECT( ohl::blockchain::short_operation_v1, (amount)(short_index) )
FC_REFLECT( ohl::blockchain::cover_operation, (amount)(cover_index)(reserved) )
FC_REFLECT( ohl::blockchain::add_collateral_operation, (amount)(cover_index) )
