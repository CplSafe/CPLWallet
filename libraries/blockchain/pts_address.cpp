...
namespace fc
{
   void to_variant( const ohl::blockchain::pts_address& var,  variant& vo )
   {
        vo = std::string(var);
   }
   void from_variant( const variant& var,  ohl::blockchain::pts_address& vo )
   {
        vo = ohl::blockchain::pts_address( var.as_string() );
   }
}
