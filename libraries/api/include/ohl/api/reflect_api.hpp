...
FC_API( ohl::api::wallet_api, (wallet_unlock) )
...
namespace ohl { namespace api {
   ...
   struct login_api 
   {
      public:
         ...
         fc::api<ohl::api::blockchain_api> get_blockchain()const
         {
            FC_ASSERT( _blockchain, "no permission to access blockchain" );
            return *_blockchain;
         }
         fc::api<ohl::api::wallet_api>     get_wallet()const
         {
            FC_ASSERT( _wallet, "no permission to access wallet" );
            return *_wallet;
         }

         optional<fc::api<ohl::api::blockchain_api>> _blockchain;
         optional<fc::api<ohl::api::wallet_api>>     _wallet;
         map<string,permissions>                     _permissions;
         common_api* _capi = nullptr;
   };
} } // ohl::api

FC_REFLECT( ohl::api::permissions, (password)(access) );
FC_API( ohl::api::login_api, (login)(get_blockchain)(get_wallet) )
