...
//#include <ohl/bitcoin/armory.hpp>
#include <ohl/bitcoin/bitcoin.hpp>
#include <ohl/bitcoin/electrum.hpp>
//#include <ohl/bitcoin/multibit.hpp>

#include <ohl/keyhotee/import_keyhotee_id.hpp>
...
{ try {
  if( !my->_blockchain->is_valid_account_name( fc::to_lower( keyhoteeid ) ) )
    ...
    ohl::keyhotee::profile_config config{firstname, middlename, lastname, brainkey};

    auto private_key = ohl::keyhotee::import_keyhotee_id(config, keyhoteeid);
