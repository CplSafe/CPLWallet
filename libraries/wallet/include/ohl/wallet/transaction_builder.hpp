...
} } //namespace ohl::wallet

FC_REFLECT_ENUM( ohl::wallet::vote_strategy,
        (vote_none)
        (vote_all)
        (vote_recommended)
        )
FC_REFLECT( ohl::wallet::transaction_builder, (transaction_record)(required_signatures)(outstanding_balances) )
