...
#define OHL_NET_PROTOCOL_VERSION                        106
...
#define OHL_NET_DEFAULT_PEER_CONNECTION_RETRY_TIME      30 // seconds

/**
 * AFter trying all peers, how long to wait before we check to
 * see if there are peers we can try again.
 */
#define OHL_PEER_DATABASE_RETRY_DELAY                   15 // seconds

#define OHL_NET_PEER_HANDSHAKE_INACTIVITY_TIMEOUT       5

#define OHL_NET_PEER_DISCONNECT_TIMEOUT                 20

#define OHL_NET_TEST_SEED_IP                            "104.236.44.210" // autogenerated
#define OHL_NET_TEST_P2P_PORT                           1700
#define OHL_NET_DEFAULT_P2P_PORT                        50006
#define OHL_NET_DEFAULT_DESIRED_CONNECTIONS             20
#define OHL_NET_DELEGATE_DESIRED_CONNECTIONS            50
#define OHL_NET_DEFAULT_MAX_CONNECTIONS                 200

#define OHL_NET_MAXIMUM_QUEUED_MESSAGES_IN_BYTES        (1024 * 1024)
 ...
 */
#define OHL_NET_FUTURE_SYNC_BLOCKS_GRACE_PERIOD_SEC     (60 * 60)

#define OHL_NET_INSUFFICIENT_RELAY_FEE_PENALTY_SEC      15

#define OHL_NET_MAX_INVENTORY_SIZE_IN_MINUTES           2

#define OHL_NET_MAX_BLOCKS_PER_PEER_DURING_SYNCING      100
 ...
 */
#define OHL_NET_MIN_BLOCK_IDS_TO_PREFETCH               10000
