...
#include <ohl/net/chain_server_commands.hpp>
    ...
    namespace detail {
        class chain_server_impl {
          public:
            ...
            std::shared_ptr<ohl::blockchain::chain_database> _chain_db;
            ...
            chain_server_impl(std::shared_ptr<ohl::blockchain::chain_database> chain_ptr, uint16_t port)
              : _chain_db(chain_ptr),
...
ohl::net::chain_server::chain_server(std::shared_ptr<ohl::blockchain::chain_database> chain_ptr, uint16_t port)
...
uint16_t ohl::net::chain_server::get_listening_port()
{
