...
static_assert((int)ohl::net::block_message_type == (int)ohl::client::block_message_type, "enum values don't match");
static_assert((int)ohl::net::trx_message_type == (int)ohl::client::trx_message_type, "enum values don't match");
