...
struct chain_fixture
{
   ...
   { try {
      ...
      try {
      sim_network = std::make_shared<ohl::net::simulated_network>("dev_fixture");

      ohl::blockchain::start_simulated_time(fc::time_point::from_iso_string( "20200101T000000" ));
      ohl::utilities::set_random_seed_for_testing( fc::sha512() );
      ...
      clienta = std::make_shared<ohl::client::client>("dev_fixture", sim_network);
      ...
      clientb = std::make_shared<ohl::client::client>("dev_fixture", sim_network);
   ...
   void exec( std::shared_ptr<ohl::client::client> c, const string& command_to_run )
   {
      if( c == clienta )
   ...
   std::shared_ptr<ohl::net::simulated_network> sim_network;
   std::shared_ptr<ohl::net::simulated_network> sim_network_fork;
   std::shared_ptr<ohl::client::client>        clienta;
   fc::future<void>                            _clienta_done;
   std::shared_ptr<ohl::client::client>        clientb;
