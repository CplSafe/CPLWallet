...
class Account : public QObject
{
   ...
   TransactionSummary* buildSummary(ohl::wallet::transaction_ledger_entry trx);

public:
   Account(ohl::light_wallet::light_wallet* wallet,
           const ohl::light_wallet::account_record& account,
           QObject* parent = nullptr);
   virtual ~Account(){}

   Account& operator= (const ohl::light_wallet::account_record& account);
