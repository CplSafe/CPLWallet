...
class ClientWrapper : public QObject 
{
  ...
  public:
    ...
    {
    public:
      virtual void on_config_loaded(const ohl::client::config& config) = 0;
    ...
    std::shared_ptr<ohl::client::client> get_client() { return _client; }
...
public Q_SLOTS:
  ...
  private:
    ohl::client::config                  _cfg;
    std::shared_ptr<ohl::client::client> _client;
    fc::future<void>                     _client_done;
    fc::thread                           _ohlshares_thread;
    fc::future<void>                     _init_complete;
    fc::optional<fc::ip::endpoint>       _actual_httpd_endpoint;
    QSettings                            _settings;

    std::shared_ptr<ohl::net::upnp_service> _upnp_service;
